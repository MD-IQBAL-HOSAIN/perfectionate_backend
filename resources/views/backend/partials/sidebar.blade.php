        ...
        <ul>
            ...
            <li class="nav-item nav-item-has-children active show">
                ...
                <ul id="settings"
                    ...
                    <li>
                    <li class="nav-item {{ Request::routeIs('profile.setting') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ Request::routeIs('system.index') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ Request::routeIs('mail.setting') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ Request::routeIs('social.media') ? 'active' : '' }}">
                        <a href="{{ route('social.media') }}" class="index']) }}">
                            <span class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <li class="nav-item {{ Request::routeIs('dynamic.index') ? 'active' : '' }}">
                    ...
                    {{-- <li class="nav-item {{ Request::routeIs('stripe.index') ? 'active' : '' }}">
