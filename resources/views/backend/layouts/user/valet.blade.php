                        ...
                        <table class="table table-bordered text-nowrap border-bottom w-100" id="datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">Approval</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#datatable')) {
                let dTable = $('#datatable').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('user.valet-approved.index') }}",
                        type: "GET",
                    },
        ...
        $(document).on('change', '.valet-status-select', function() {
            let userId = $(this).data('id');
            let status = $(this).val();

            $.ajax({
                url: '/admin/update-valet-status',  // Ensure this matches the route
                type: 'POST',
                data: {
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        toastr.success('Valet status updated successfully');
                    } else {
