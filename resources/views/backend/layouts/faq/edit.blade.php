                    ...
                    <form method="post" action="{{ route('faq.update', ['id' => $data->id]) }}" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('question_en') is-invalid @enderror"
                                   name="question_en" placeholder="Faq Question English" id="question_en" value="{{ old('question_en', $data->getTranslation('question', 'en')) }}">
                            @error('question_en')
                        ...
                        <div class="form-group" dir="rtl">
                            ...
                            <input type="text" class="form-control @error('question_ar') is-invalid @enderror"
                                   name="question_ar" placeholder="Faq Question Arabic" id="question_ar" value="{{ old('question_ar', $data->getTranslation('question', 'ar')) }}">
                            @error('question_ar')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('answer_en') is-invalid @enderror" name="answer_en" id="answer_en" placeholder="Faq Answer English" cols="30" rows="3">{{ old('answer_en', $data->getTranslation('answer', 'en')) }}</textarea>
                            @error('answer_en')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group" dir="rtl">
                            ...
                            <textarea class="form-control @error('answer_ar') is-invalid @enderror" name="answer_ar" id="answer_ar" placeholder="Faq Answer Arabic" cols="30" rows="3">{{ old('answer_ar', $data->getTranslation('answer', 'ar')) }}</textarea>
                            @error('answer_ar')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
