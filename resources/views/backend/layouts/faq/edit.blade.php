                    ...
                    <form method="post" action="{{ route('faq.update', ['id' => $data->id]) }}" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('question') is-invalid @enderror"
                                   name="question" placeholder="Faq Question" id="question" value="{{ old('question', $data->question) }}">
                            @error('question')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('answer') is-invalid @enderror" name="answer" id="answer" placeholder="Faq Answer" cols="30" rows="3">{{ old('answer', $data->answer) }}</textarea>
                            @error('answer.en')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
