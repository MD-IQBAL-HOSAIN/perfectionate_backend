...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('home.content.one.update', $data->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="button_title_one">Button Title One</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="button_subtitle_one">Button Subtitle One</label>
                                    <input type="text" name="button_subtitle_one" id="button_subtitle_one"
                                        class="form-control"
                                        value="{{ old('button_subtitle_one', $data->button_subtitle_one) }}">
                                </div>
                                @error('button_subtitle_one')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="button_title_two">Button Title Two</label>
                                    <input type="text" name="button_title_two" id="button_title_two"
                                        class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="button_subtitle_two">Button Subtitle Two</label>
                                    <input type="text" name="button_subtitle_two" id="button_subtitle_two"
                                        class="form-control"
                                        value="{{ old('button_subtitle_two', $data->button_subtitle_two) }}">
                                </div>
                                @error('button_subtitle_two')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="button_title_three">Button Title Three</label>
                                    <input type="text" name="button_title_three" id="button_title_three"
                                        class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="button_subtitle_three">Button Subtitle Three</label>
                                    <input type="text" name="button_subtitle_three" id="button_subtitle_three"
                                        class="form-control"
                                        value="{{ old('button_subtitle_three', $data->button_subtitle_three) }}">
                                </div>
                                @error('button_subtitle_three')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="image_three" id="image_three" class="form-control dropify"
                                        data-default-file="{{ asset($data->image_three) }}">
                                    @error('image_three')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
