    ...
    public function index(Request $request): View | JsonResponse
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('customers_limit', function ($data) {
                    return $data->customers_limit;
                })               
                ...
                ->rawColumns(['title', 'type','plan_code','currency', 'price', 'customers_limit','sms_limit', 'customize_birth_message', 'status', 'action'])
                ->make();
        }
